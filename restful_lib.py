...
class Connection:
    ...
    # Added by 4nT0 # START
    def add_rest_credentials(self,username, password):
        self.rest_credentials = base64.b64encode(\
    ...
    def request(self, resource, method = "get", args = None, body = None, filename=None, headers={}):
        ...
        # Added by 4nT0 # START
        if self.rest_credentials:
            headers['Authorization'] = 'Basic %s' % (self.rest_credentials)
        # Added by 4nT0 # END
